...
tennis_data.Humidity = tennis_data.Humidity.replace('High', 5)
tennis_data.Humidity = tennis_data.Humidity.replace('Normal', 6)

tennis_data.PlayTennis = tennis_data.PlayTennis.replace('No', 7)
tennis_data.PlayTennis = tennis_data.PlayTennis.replace('Yes', 8)
